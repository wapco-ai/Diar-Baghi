...
const LoginPage = () => {
  ...
  const handleSubmitPhone = async (e) => {
    ...
    try {
      ...
      setSubmitError('خطا در ارسال کد تایید');
  ...
  useEffect(() => {
    ...
    const runOtpSuccessFlow = async () => {
      ...
      try {
        ...
        setSubmitError('کد وارد شده معتبر نیست');
      } finally {
        setIsSubmitting(false);
      }
    };
      ...
      <div className="login-container">
        ...
        <div className="login-text-content">
          <h1 className="login-title">
            {showVerification ? 'ورود کد تایید' : 'ورود به حساب کاربری'}
          </h1>

          {showVerification ? (
            <div className="verification-message">
              <p>
                کد تایید به شماره <span dir="ltr" className="phone-number">{formattedPhone}</span> ارسال شد
              </p>
            ...
            <p className="login-description">شماره موبایل خود را وارد کنید</p>
          )}
        </div>
        ...
        {showVerification ? (
          <div className="verification-container" dir="ltr">
            ...
            <div className="verification-resend">
              {countdown > 0 ? (
                <span>ارسال مجدد کد تا {countdown} ثانیه</span>
              ) : (
                <button
                  type="button"
        ...
        {!showVerification && (
          <div className="login-terms">
            <p>
              با ورود به اپلیکیشن، شما با <a href="#">قوانین و مقررات</a> موافقت می‌کنید
            </p>
          </div>
        )}
      </div>
